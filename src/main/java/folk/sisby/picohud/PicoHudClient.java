...
public class PicoHudClient implements ClientModInitializer, HudRenderCallback {
	...
	public void onHudRender(MatrixStack matrixStack, float tickDelta) {
		...
		if (CONFIG.showCoordinates) {
			MutableText coordinateText = new TranslatableText("picohud.hud.coordinates", cameraEntity.getBlockX(), cameraEntity.getBlockY(), cameraEntity.getBlockZ());
		...
		if (CONFIG.showBiome) {
			...
			MutableText biomeText = new TranslatableText("biome.%s.%s".formatted(biomeId.getNamespace(), biomeId.getPath()));
